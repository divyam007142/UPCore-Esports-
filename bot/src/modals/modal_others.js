...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    const category = await resolveTicketCategory(interaction, 'others');
    if (!category) return;
    ...
    await Ticket.create({
      ...
      username: interaction.user.tag, category: 'others',
    ...
    const formEmbed = new EmbedBuilder()
      ...
      .setFooter({ text: `UPCore  •  Others  •  User Submission${anyTranslated ? '  •  Auto-translated to English' : ''}` });
    ...
    await logTicketAction(client, 'TICKET_OPEN', {
      ...
      fields: [
        ...
        { name: `${e('log') || '🗂️'}  Category`,        value: '`Others`',                                                 inline: true  },
